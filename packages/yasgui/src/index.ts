...
import { default as Yasqe, PartialConfig as YasqeConfig, RequestConfig } from "@sral/yasqe";
import { default as Yasr, Config as YasrConfig } from "@sral/yasr";
import { addClass, removeClass } from "@sral/yasgui-utils";
require("./index.scss");
require("@sral/yasr/src/scss/global.scss");
if (window) {
